...
PIPELINE_SCRIPTS = ["prospect_finder.py", "yellowpages_scraper.py", "superpages_scraper.py", "manta_scraper.py", "prospect_enricher.py", "prospect_qualifier.py", "outreach_generator.py"]
